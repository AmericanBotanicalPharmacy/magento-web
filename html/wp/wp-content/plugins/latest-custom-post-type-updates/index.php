...
if(!class_exists('tmcp') && class_exists('WP_Widget')):
    class tmcp extends WP_Widget {
        function tmcp() {
    ...
    add_action('widgets_init',
        create_function('', 'return register_widget("tmcp");')
    );
    add_action('wp_ajax_tm_lcptu_get_taxonomies',
        array('tmcp', 'get_post_taxonomies')
    );
endif; // if !class_exists('tmcp') && class_exists('WP_Widget')
