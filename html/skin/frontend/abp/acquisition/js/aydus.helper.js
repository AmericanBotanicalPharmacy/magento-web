...
function Helper() {
    ...
    this.isScrollView = function(e) {
        ...
        // True when "whole" element scrolls into view.
        return ((elemBottom <= docViewBottom) && (elemTop >= docViewTop));
    }

    this.isScrollIntoView = function(e, scrollOffset) {
        ...
        // True when bottom of element scrolls into view.  Padding makes scroll into view occur early.
        return ((elemBottom - scrollOffset <= docViewBottom));
    }
