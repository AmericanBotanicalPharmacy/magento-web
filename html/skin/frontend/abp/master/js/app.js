...
* Author: Aydus
* Description:
*  - Display sidebar summary on tablet (instead of desktop only).
*  - Remove zoom functionality. Find a way to disable zoom without changing source js.
*/
...
$j(document).ready(function () {
    ...
    // mod start Aydus 9/20/2014: Display sidebar summary on tablet (instead of desktop only).
    // Preferred: remove enquire event and set via abp.js.
    if ($j('body.checkout-onepage-index').length) {
        enquire.register('(max-width: ' + _responsive.tabletLandscapeWidth - 1 + 'px)', {
            match: function () {
...
var ProductMediaManager = {
    ...
    createZoom: function(image) {
        //mod start Aydus 10/14/2014: Remove zoom functionality. Find a way to disable zoom without changing source js.
        return;
        //mod end
