...
s.linkInternalFilters="javascript:,herbdoc.com"
...
s.usePlugins=true
	...
	if(!s.campaign)
 	...
 	var ddt1= new Date();
	s.prop1=s.getTimeParting('h','-7',ddt1.getFullYear()); // Set hour 
 	s.prop2=s.getTimeParting('d','-7',ddt1.getFullYear()); // Set day
  	s.prop3=s.getTimeParting('w','-7',ddt1.getFullYear()); // Set Weekend / Weekday
...
s.visitorNamespace="herbdoc"
s.trackingServer="herbdoc.112.2o7.net"
