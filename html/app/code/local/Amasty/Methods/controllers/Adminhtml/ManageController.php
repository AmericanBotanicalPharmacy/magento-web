...
*/
class Amasty_Methods_Adminhtml_ManageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Visibility options have been saved.'));
