...
class Fishpig_Wordpress_Block_Cd extends Fishpig_Wordpress_Block_Post_List_Wrapper_Abstract
{
	/**
	...
	protected function _beforeToHtml()
	{
		...
		if (!$this->getTemplate()) {
			$this->setTemplate('wordpress/cd.phtml');
		}
...
//			if ($tag = $this->getTag()) {
                        $tag = "cds-dvds";
				$collection->addTermFilter($tag, 'bookcategory', 'slug');
//			}
