...
class Fishpig_Wordpress_Block_Video extends Fishpig_Wordpress_Block_Post_List_Wrapper_Abstract
{
	/**
	...
	protected function _beforeToHtml()
	{
		...
		if (!$this->getTemplate()) {
			$this->setTemplate('wordpress/video.phtml');
		}
	...
	{
		return $this->_getData('number') ? $this->_getData('number') : 10;
	}
...
//			if ($tag = $this->getTag()) {
                           ...
                           // $collection->addMetaFieldToFilter('_jsFeaturedPost', 'yes');
