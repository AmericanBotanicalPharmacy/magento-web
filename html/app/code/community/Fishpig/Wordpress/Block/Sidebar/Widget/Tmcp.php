...
class Fishpig_Wordpress_Block_Sidebar_Widget_Tmcp extends Fishpig_Wordpress_Block_Sidebar_Widget_Abstract
implements Mage_Widget_Block_Interface
{
	...
	{
		return $this->_getData('number') ? $this->_getData('number') : 16;
	}
...
//			}
	...
	public function getListId()
	{
		if (!$this->hasListId()) {
			...
			$this->setListId(substr($hash, 0, 16));
		}
